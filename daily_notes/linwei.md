...
1、开源平台 r0.1.7-rc0 版本重新部署集群测试 -- 完成
...
1、开源平台 r0.1.7-rc0 版本测试 100%（集群部署成功，推送和拉起镜像都是按照配置文件配置的版本镜像推送和拉起，job 可以正常运行）
...
1、开源平台 r0.1.7-rc0 版本测试 70%（重新部署集群，完成各种配置更新，K8S集群和harbor搭建）
...
1、开源平台 r0.1.7-rc0 版本测试 30%（在现有的集群，更新业务镜像成功，版本号有升级，重启服务后pod拉起配置的版本的镜像）
...
1、开源平台 0.1.5版本系统测试     -- 完成

2、开源平台主流程测试和GPU提交JOB专项测试   -- 完成
