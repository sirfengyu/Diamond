## 2020-09-04
1. 已协调一台jumpserver专用的服务器，部署完成50%
2. aiarts的测试用例评审

## 2020-09-03
1. 学习ceph基本知识
2. 熟悉碧峰写的无网部署文档，已完成，待有环境后进行部署

## 2020-09-02
1. jumpserver使用说明及后续服务器管理的规则制定，已完成
2. 算法组服务器升级到0.1.6版本，已完成

## 2020-08-31
1. 客户演示AIArts环境：3.66环境验证，完成80%，因计划变更，停止验证
2. 客户演示AIArts环境：30000环境验证，完成100%

## 2020-08-28
1. jumpserver调研，完成100%
...
## 2020-08-26
1. 开源平台0.1.5版本bug回归完成100%；npu分布式job低频偶现无法正常运行，复现中

## 2020-08-25
1. 开源平台0.1.5版本bug回归完成90%，regular job测试完成，分布式job暂无法测试，鹏浩修改中
2. harbor仓库镜像版本管理需求讲解

## 2020-08-24
1. 开源平台0.1.4版本已修复bug的回归测试===除提交job页面，调度策略相关的bug以外，均回归完成
2. 南京环境部署checklist评审

>>>>>>> e69bc7f5fa4071d2d8138b957c69931afcd10f76
## 2020-08-21
1. 开源平台0.1.4版本主流程测试，已完成
2. 0.1.4版本已修复bug的回归测试，已完成
3. 开源平台调度策略的评审

## 2020-08-20
1. 开源平台新增功能==用户和vc关联的测试，完成70%
...
## 2020-08-12
1. 研究院的测试环境，已测试部署3次，部分镜像包名称中有sz_gongdianju，第四次部署测试中
2. aiarts平台==总览、模型管理、用户管理模块的测试报告已完成

## 2020-08-11
1. aiarts平台==总览、模型管理、用户管理模块的测试用例编写，完成100%；精朗模块的用例已合并，其余用例未提供
2. 研究院的测试环境，系统已重装为18.04.4；平台的安装盘正在制作中
3. aiarts平台==总览、模型管理、用户管理模块的用户手册，完成40%

## 2020-08-10
1. aiarts平台==总览、模型管理、用户管理模块的测试用例编写，完成90%
2. （深圳人工智能与机器人研究院）客户环境已确认，已准备好一台GPU服务器并重装为18.04.1的系统，需等HA的4台部署完成后再部署
...
## 2020-08-06
1. 平台更新：aiarts平台-模型管理模块的测试，完成100%
2. 已修复bug的回归测试，完成50%

## 2020-08-05
1. aiarts平台-模型管理模块的测试，完成100%
