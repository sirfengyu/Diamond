root@atlas02:/dlwsdata# cat /etc/apt/sources.list.bak
#
...
# deb-src [arch=arm64] https://download.docker.com/linux/ubuntu bionic stable
# deb-src [arch=arm64] https://download.docker.com/linux/ubuntu bionic stable
# deb-src [arch=arm64] https://download.docker.com/linux/ubuntu bionic stable
# deb-src [arch=arm64] https://download.docker.com/linux/ubuntu bionic stable
# deb-src [arch=arm64] https://download.docker.com/linux/ubuntu bionic stable
...
root@atlas02:~# cd /usr/local/Ascend/driver/
